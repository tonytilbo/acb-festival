...
static class BeerData
{
    ...
    [
        new(1,  "Thornbridge Brewery",      "Jaipur",               "India Pale Ale",       5.9m, "A bold, citrus-forward IPA bursting with grapefruit, mango and pine resin. A clean bitter finish that keeps you coming back.",              "Keg"),
        ...
        new(11, "Siren Craft Brew",         "Broken Dream",         "Breakfast Stout",      6.5m, "Rich and indulgent with roasted coffee, dark chocolate and a whisper of vanilla. Smooth, creamy body and a lingering bitter finish.",        "Keg"),
        new(12, "Wild Beer Co.",            "Bibble",               "Pale Ale",             4.2m, "Hazy and hop-forward with fresh lemon, white peach and herbal notes. Light-bodied and wonderfully aromatic.",                               "Keg"),
        ...
        new(17, "Kernel Brewery",           "Table Beer",           "Session Pale Ale",     3.3m, "Low alcohol, high flavour — citrus zest, fresh herbs and a subtle earthiness. The perfect session companion.",                              "Keg"),
        new(18, "Moor Beer Company",        "Revival",              "Session IPA",          3.8m, "Unfiltered and unfined. Hazy gold with bold tropical and citrus hops punching well above the sessionable ABV.",                             "Keg"),
